...
This is the host library for MonoGame and WPF. You can only use MonoGame DirectX.

There's a sample project available at https://github.com/Thraka/SadConsole/tree/master/Samples/WPFSadConsole
