namespace SadConsole
{
    ...
    public static partial class Serializer
    {
        ...
        public static IEnumerable<Type> ConsoleTypes
        {
            get
            {
                return (new Type[] { typeof(Consoles.Console), typeof(Consoles.CellsRenderer), typeof(Consoles.ConsoleList), typeof(TextSurface), typeof(Cell), typeof(Font) }).Union(SadConsole.Engine.RegisteredEffects);
            }
        }
