...
namespace SadConsole.Consoles
{
    public class EffectsManager
    {
        ...
        protected Dictionary<ICellEffect, int[]> _effectSerialized;
        ...
        public EffectsManager(ITextSurface surface)
        {
        ...
        public void Hydrate(ITextSurface surface)
        {
            if (backingSurface != null)
                throw new Exception("Effects manager was created with an existing surface. This method is for serialization loading.");
        ...
        {
            _effectSerialized = new Dictionary<ICellEffect, int[]>(_effects.Count);
            List<Cell> currentCells = new List<Cell>(backingSurface.Cells);
    ...
    public class TextSurfaceBase : IEnumerable<Cell>, ITextSurface
    {
