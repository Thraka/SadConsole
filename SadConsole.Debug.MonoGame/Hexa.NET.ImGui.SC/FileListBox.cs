    ...
    public bool Draw(out bool itemSelected, out bool itemHighlighted)
    {
        ...
        else
        {
            ...
            if (_currentFolder.Parent != null && !_currentFolder.FullName.Equals(_rootFolder.FullName))
            {
                ...
                if (ImGui.Selectable(_parentDirectoryItem.Name, false, ImGuiSelectableFlags.NoAutoClosePopups | ImGuiSelectableFlags.AllowDoubleClick))
                {
                    if (DoubleClickToSelect && ImGuiP.IsMouseDoubleClicked(ImGuiMouseButton.Left))
            ...
            foreach (ItemType item in _currentFolderItems)
            {
                ...
                ImGuiSelectableFlags flags = ImGuiSelectableFlags.NoAutoClosePopups;
