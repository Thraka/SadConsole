...
public static partial class ImGui2
{
    ...
    private static Stack<ImRect> s_GroupPanelLabelStack = new Stack<ImRect>(2);

    public static void BeginGroupPanel(string name) =>
        BeginGroupPanel(name, new(-1, -1));
    ...
    public static void BeginGroupPanel(string name, Vector2 size)
    {
        ...
        s_GroupPanelLabelStack.Push(new ImRect(labelMin, labelMax));
    }
    ...
    public static void EndGroupPanel()
    {
        ...
        //var labelRect = s_GroupPanelLabelStack.back();
        //s_GroupPanelLabelStack.pop_back();



        Vector2 halfFrame = new Vector2(frameHeight * 0.25f, frameHeight) * 0.5f;
        ImRect frameRect = new ImRect(itemMin + halfFrame, itemMax - new Vector2(halfFrame.X, 0.0f));
    ...
    public unsafe static void EndGroupPanel1()
    {
        ImGui.PopItemWidth();
