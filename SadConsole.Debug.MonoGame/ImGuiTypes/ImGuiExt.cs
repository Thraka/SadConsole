...
public static partial class ImGuiExt
{
    ...
    public static void DrawTextureChild(string id, bool border, int zoomMode, ImTextureID texture, Vector2 textureSize, out bool isItemActive, out bool isItemHovered) =>
        DrawTextureChild(id, border, zoomMode, texture, textureSize, ImGui.GetContentRegionAvail(), out isItemActive, out isItemHovered);

    public static void DrawTextureChild(string id, bool border, int zoomMode, ImTextureID texture, Vector2 textureSize, Vector2 region, out bool isItemActive, out bool isItemHovered)
    {
        ImGui.PushID(id);
