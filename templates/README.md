...
These are the .NET templates for SadConsole. For more information, see [Create a new SadConsole .NET project with the SadConsole templates](https://sadconsole.com/articles/getting-started-cli.html).
