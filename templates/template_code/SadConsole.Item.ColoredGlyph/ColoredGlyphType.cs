...
public class ColoredGlyphType : ColoredGlyphBase, IMatchable<ColoredGlyphType>
{
    ...
    /// </summary>
    public ColoredGlyphType() : this(Color.White, Color.Black, 0, Mirror.None) { }

    /// <summary>
    /// Creates a cell with the specified foreground, black background, glyph 0, and no mirror effect.
    /// </summary>
    /// <param name="foreground">Foreground color.</param>
    public ColoredGlyphType(Color foreground) : this(foreground, Color.Black, 0, Mirror.None) { }
    ...
    public ColoredGlyphType(Color foreground, Color background) : this(foreground, background, 0, Mirror.None) { }
    ...
    public ColoredGlyphType(Color foreground, Color background, int glyph) : this(foreground, background, glyph, Mirror.None) { }
    ...
    public ColoredGlyphType(Color foreground, Color background, int glyph, Mirror mirror)
    {
    ...
    {
        ColoredGlyphType glyph = new(Foreground, Background, Glyph, Mirror)
        {
            IsVisible = IsVisible,
        };
