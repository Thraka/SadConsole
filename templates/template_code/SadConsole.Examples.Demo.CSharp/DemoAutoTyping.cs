...
class AutoTyping : Console
{
    ...
    public AutoTyping() : base(GameSettings.ScreenDemoBounds.Width, GameSettings.ScreenDemoBounds.Height)
    {
        ...
        string[] text = new string[] {
                                           "[c:r f:ansiwhite]Welcome to the [c:g f:black:red:black:10][c:r b:White]SadConsole[c:u] demo template!",
                                           "",
                                           ...
                                           "",
                                           "The following items are examples of what you can find in this sample app:",
                                           "",
                                           "[c:r f:LightGreen]01[c:r f:green])[c:u 2] String Parser     -- [c:r f:white]Examples of using the string parser functions[c:u]",
                                           "[c:r f:LightGreen]02[c:r f:green])[c:u 2] Controls Test     -- [c:r f:white]Displays all SadConsole.Controls for testing[c:u]",
                                           "[c:r f:LightGreen]03[c:r f:green])[c:u 2] Shapes            -- [c:r f:white]Draw different shapes[c:u]",
                                           "[c:r f:LightGreen]04[c:r f:green])[c:u 2] Splash Screen     -- [c:r f:white]Sample splash screen advertising [c:g f:black:red:black:10][c:r b:White]SadConsole[c:u 2]",
                                           "[c:r f:LightGreen]05[c:r f:green])[c:u 2] DOS\\Terminal      -- [c:r f:white]A terminal prompt that accepts commands[c:u]",
                                           "[c:r f:LightGreen]06[c:r f:green])[c:u 2] Multiple Cursors  -- [c:r f:white]Multiple cursors typing on a single console[c:u]",
                                           "[c:r f:LightGreen]07[c:r f:green])[c:u 2] 2000x2000 Console -- [c:r f:white]2000x2000 console that is scrollable[c:u]",
                                           ...
                                           "[c:r f:LightGreen]10[c:r f:green])[c:u 2] Ascii Graphics    -- [c:r f:white]Displays Ansi, REXPaint and Playscii files.[c:u]",
                                           "[c:r f:LightGreen]11[c:r f:green])[c:u 2] Animations        -- [c:r f:white]Show use of instructions and AnimatedScreenSurface[c:u]",
                                           "[c:r f:LightGreen]12[c:r f:green])[c:u 2] Entity demo       -- [c:r f:white]1000s of entities on the screen moving around[c:u]",
                                           "[c:r f:LightGreen]--[c:r f:green])[c:u 2] And more!!",
                                         };
