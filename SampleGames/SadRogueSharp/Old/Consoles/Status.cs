...
namespace SadRogueSharp.Consoles
{
    class Status: SadConsole.Console
    {
        public Status(): base(30, 30)
        {
            ...
            Print(1, 0, "SadConsole + RogueSharp".Align(System.Windows.HorizontalAlignment.Center, 29).CreateGradient(Color.Moccasin, Color.Gray));

            Print(2, 2, "Health", Color.GreenYellow);
            Print(10, 2, new string((char)176, 19).CreateGradient(Color.Red, Color.GreenYellow));

            Print(2, 4, "Energy", Color.GreenYellow);
            Print(10, 4, new string((char)176, 19).CreateGradient(Color.Blue, Color.GreenYellow));
