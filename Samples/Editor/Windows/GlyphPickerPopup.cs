...
{
    public static bool Show(ImGuiRenderer renderer, string popupId, IFont font, nint fontTexture, Point fontTextureSize, ref int selectedGlyph)
    {
        ...
        if (ImGui.BeginPopup(popupId))
        {
            ...
            ImGuiExt.DrawTextureChild("font_preview", true, ImGuiExt.ZoomNormal, ((Host.GameTexture)font.Image).Texture, renderer, out bool isActive, out bool isHovered);
