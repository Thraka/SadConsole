...
namespace FeatureDemo.Windows
{
    internal class CharacterViewer : Window
    {
        ...
        private readonly ScrollBar _charScrollBar;
        ...
        {
            fontRowOffset = ((ScrollBar)sender).Value;
            hasDrawn = false;
        }
        ...
        { 
            ...
            this.SetGlyph(Width - 1, Height - 3, 185);
            for (int i = 1; i < Width - 1; i++)
            {
                this.SetGlyph(i, Height - 3, 205);
            }
        ...
        private void DrawHoverItemString()
        {
            ...
            ColoredString text = items[0].CreateColored(Color.LightBlue, borderStyle.Background, null) +
        ...
        private void DrawSelectedItemString()
        {
            ...
            ColoredString text = items[0].CreateColored(Color.LightBlue, borderStyle.Background, null) +
                       items[1].CreateColored(Color.LightCoral, borderStyle.Background, null) +
                       items[2].CreateColored(Color.LightCyan, borderStyle.Background, null) +
                       items[3].CreateColored(Color.LightCoral, borderStyle.Background, null) +
                       items[4].CreateColored(Color.LightCyan, borderStyle.Background, null);
