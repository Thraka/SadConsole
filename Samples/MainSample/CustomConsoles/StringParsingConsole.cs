...
namespace FeatureDemo.CustomConsoles
{
    internal class StringParsingConsole : ScreenSurface
    {
        public StringParsingConsole() : base(80, 23)
        {
            ...
            this.Print(1, r, "[c:r f:ansibluebright][c:r b:ansiblue]String parsing supports...                                                    ");
            this.SetGlyph(0, r, 221, Color.Black, ColorAnsi.Blue);

            r = 2;
            Color a = Color.Green;
            this.Print(1, ++r, "[c:r f:DodgerBlue]1.[c:r f:White] Multi-colored [c:r f:yellow]str[c:r f:red]ings");
            r++;
            this.Print(1, ++r, "[c:r f:DodgerBlue]2.[c:r f:White] You color the backgrounds: [c:r f:black][c:r b:Purple] Purple [c:u] [c:r b:Cyan] Cyan ");
            r++;
            this.Print(1, ++r, "[c:r f:DodgerBlue]3.[c:r f:White] [c:g f:LimeGreen:Orange:9]Gradients are [c:g b:Black:Red:Yellow:Red:Black:15]easily supported");
            r++;
            this.Print(1, ++r, "[c:r f:DodgerBlue]4.[c:r f:White] You [c:b 3]can apply [c:b 5:0.17]blink effects.");
            r++;
            this.Print(1, ++r, "[c:r f:DodgerBlue]5.[c:r f:White] You set [c:r f:greenyellow:9]mirroring [c:m 1]on any [c:m 2]text [c:u][c:u]you want.");

            r += 2;
            this.Print(1, r, "[c:r f:ansibluebright][c:r b:ansiblue]Examples                                                                      ");
            this.SetGlyph(0, r, 221, Color.Black, ColorAnsi.Blue);
            ...
            this.Print(1, r, "Some `[c:r f:red]text`[c:u] to print                       ");
            this.Print(c + 2, r, $"Some [c:r f:{Color.Red.ToParser()}]text[c:u] to print");



            this.Print(1, ++r, "Some `[c:r f:100,100,33]text`[c:u] to print");
            this.Print(c + 2, r, "Some [c:r f:255,255,0]text[c:u] to print");

            this.Print(1, ++r, "Some `[c:r b:ansiblackbright]text to `[c:r f:white]print");
            this.Print(c + 2, r, "Some [c:r b:ansiblackbright]text to [c:r f:white]print");

            this.Print(1, ++r, "`[c:m 1]Some `[c:r f:purple]text to`[c:u] pr`[c:u]int");
            this.Print(c + 2, r, "[c:m 1]Some [c:r f:purple]text to[c:u] pr[c:u]int");

            this.Print(1, ++r, "[c:r f:default]`[c:g f:red:green:18]`[c:g b:green:red:18]Some text to print");
            this.Print(c + 2, r, "[c:g f:red:green:18][c:g b:green:red:18]Some text to print");
        }
