    ...
    class ClassicConsoleKeyboardHandler
    {
        ...
        public bool HandleKeyboard(IConsole console, KeyboardInfo info)
        {
            ...
            foreach (var key in info.KeysPressed)
            {
                ...
                else if (key.XnaKey == Key.BackSpace)
                {
                ...
                else if (key.XnaKey == Key.Return)
                {
                    ...
                    string prompt = ((CustomConsoles.DOSConsole)console).Prompt;
                    int startingIndex = TextSurface.GetIndexFromPoint(new Vector2i(prompt.Length, VirtualCursorLastY), console.TextSurface.Width);
