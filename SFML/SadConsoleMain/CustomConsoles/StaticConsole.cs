namespace StarterProject.CustomConsoles
{
    ...
    class StaticConsole: Console
    {
            ...
            : base(80, 25)
        {
            ...
            Print(2, 2, new ColoredString("Text using a colored string", Color.Blue, Color.Transparent));

            // Creates a new ColoredString from an existing string and applies a gradient color to each character.
            ColoredString colorString = "Text using a colored string gradient".CreateGradient(Color.Green, Color.Magenta);
            Print(2, 3, colorString);

            // Appends a new ColoredString to the existing ColoredString with a new color gradient.
            colorString += " with another gradient applied".CreateGradient(Color.Blue, Color.Cyan);
            ...
            SetForeground(17, 5, Color.Yellow);
            ...
            SetBackground(17, 7, Color.White);
            SetForeground(17, 7, Color.Black);
