...
public static partial class Core
{
    public static class State
    {
        ...
        public static ImGuiList<Documents.IBuilder> DocumentBuilders = new(new Documents.DocumentSurface.Builder(), new Documents.DocumentLayeredSurface.Builder(), new Documents.DocumentAnimated.Builder());
