        ...
        public bool HandleKeyboard(IConsole console, KeyboardInfo info)
        {
            ...
            foreach (var key in info.KeysPressed)
            {
                ...
                else if (key.XnaKey == Keys.Enter)
                {
                    ...
                    string prompt = ((CustomConsoles.DOSConsole)console).Prompt;
                    int startingIndex = console.Data.GetIndexFromPoint(new Point(prompt.Length, VirtualCursorLastY));
                    string data = console.Data.GetString(startingIndex, console.Data.GetIndexFromPoint(console.VirtualCursor.Position) - startingIndex);
