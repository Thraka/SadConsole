...
#pragma warning disable 1591
    public class LayeredJsonConverter : JsonConverter<LayeredConsole>
    {
        ...
        {
            serializer.Serialize(writer, (LayeredConsoleSerialized)value);
        }

        public override LayeredConsole ReadJson(JsonReader reader, Type objectType, LayeredConsole existingValue, bool hasExistingValue, JsonSerializer serializer)
        {
            return serializer.Deserialize<LayeredConsoleSerialized>(reader);
        }
    }
    ...
    public class LayeredConsoleSerialized: ScrollingConsoleSerialized
    {
        ...
        public static implicit operator LayeredConsoleSerialized(LayeredConsole surface)
        {
            return new LayeredConsoleSerialized()
            {
        ...
        {
            var layers = surface.Layers != null ? surface.Layers.Select(l => (CellSurfaceLayer)l) : null;
