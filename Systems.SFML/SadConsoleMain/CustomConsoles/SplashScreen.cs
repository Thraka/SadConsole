namespace StarterProject.CustomConsoles
{
    ...
    class SplashScreen: Console
    {
        ...
        private Vector2i _consoleImagePosition;
            ...
            : base(80, 25)
        {
            ...
            _consoleImagePosition = new Vector2i(TextSurface.Width / 2 - _consoleImage.Width / 2, -1);
            ...
            moveGradientInstruction.CodeCallback = (inst) =>
                {
                    ...
                    Algorithms.GradientFill(TextSurface.Font.Size, new Vector2i(_x, 12), 10, 45, new IntRect(0, 0, TextSurface.Width, TextSurface.Height), new ColorGradient(colors, colorStops), SetForeground);
                };
            ...
            _animation.Instructions.AddLast(new DrawString(this) { Position = new Vector2i(26, this.TextSurface.Height - 1), Text = logoText, TotalTimeToPrint = 1f });
                ...
                CodeCallback = (i) =>
                    {
                        ...
                        {
                            var point = new Vector2i(26, this.TextSurface.Height - 1).ToIndex(this.TextSurface.Width) + 14 + index;
