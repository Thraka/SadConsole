...
public class EntityManager : Components.UpdateComponent, Components.IComponent, IList<Entity>, IDisposable
{
        ...
        if (entity.IsSingleCell)
            ...
            return entity.UsePixelPositioning
                    ...
                    : _screen!.Surface.View.Intersects(new Rectangle()
                                                        ...
                                                        .WithSize(entity.AppearanceSurface.Animation.Width,
                                                                  entity.AppearanceSurface.Animation.Height));
    }
    ...
    private Rectangle GetAnimatedAreaOffsetByCenterPixel(Entity entity) =>
        new(entity.Position.X - (entity.AppearanceSurface!.Animation.Center.X * _screenCachedFontSize.X),
                      ...
                      entity.AppearanceSurface.Animation.Width * _screenCachedFontSize.X,
