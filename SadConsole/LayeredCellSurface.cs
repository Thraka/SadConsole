...
namespace SadConsole
{
    ...
    /// </summary>
    public partial class LayeredCellSurface : CellSurface
    {
        ...
        public LayeredCellSurface(int width, int height, int layers) : this(width, height, width, height, layers)
        {
        ...
        /// <param name="layers">The number of layers to add to this surface.</param>
        public LayeredCellSurface(int width, int height, int bufferWidth, int bufferHeight, int layers) : base(width, height, bufferWidth, bufferHeight, null)
        {
        ...
        public LayeredCellSurface(int width, int height, ColoredGlyph[][] initialCells) : this(width, height, width, height, initialCells)
        {
        ...
        /// <param name="bufferHeight">The total height of the surface in cells.</param>
        /// <param name="initialCells">The cells to seed the surface with. If <see langword="null"/>, creates the cell array for you.</param>
        public LayeredCellSurface(int width, int height, int bufferWidth, int bufferHeight, ColoredGlyph[][] initialCells): base(width, height, bufferWidth, bufferHeight, initialCells?[0])
        {
