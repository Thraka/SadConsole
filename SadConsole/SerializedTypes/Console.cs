...
namespace SadConsole.SerializedTypes
{
    ...
    public class ConsoleSerialized
    {
        ...
        public static implicit operator Console(ConsoleSerialized surface) => new Console(surface.Width, surface.Height, surface.Cells.Select(c => (Cell)c).ToArray())
        {
            Font = surface.Font ?? GameHost.Instance.DefaultFont,
            Tint = surface.Tint,
            DefaultForeground = surface.DefaultForeground,
            DefaultBackground = surface.DefaultBackground,
            Position = surface.Position,
