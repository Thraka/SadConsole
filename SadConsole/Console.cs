...
namespace SadConsole
{
    ...
    public partial class Console : CellSurface
    {
        ...
        public Console(int width, int height) : this(width, height, null, GameHost.Instance.DefaultFont)
        {
        ...
        /// <param name="width">The width of the console.</param>
        /// <param name="height">The height of the console.</param>
        public Console(int width, int height, Cell[] cells) : this(width, height, cells, GameHost.Instance.DefaultFont)
        {
        ...
        public Console(int width, int height, Cell[] cells, Font font) : base(width, height, cells)
        {
