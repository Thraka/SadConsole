...
public class LayeredScreenSurface : ScreenSurface, ILayeredData
{
    ...
    public LayeredScreenSurface(int width, int height, int bufferWidth, int bufferHeight, ColoredGlyph[]? initialCells) : base(width, height, bufferWidth, bufferHeight, initialCells)
    {
