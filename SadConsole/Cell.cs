...
namespace SadConsole
{
    ...
    public class Cell : IEquatable<Cell>
    {
        ...
        /// </summary>
        public Cell() : this(Color.White, Color.Black, 0, Mirror.None) { }

        /// <summary>
        /// Creates a cell with the specified foreground, black background, glyph 0, and no mirror effect.
        /// </summary>
        /// <param name="foreground">Foreground color.</param>
        public Cell(Color foreground) : this(foreground, Color.Black, 0, Mirror.None) { }
        ...
        public Cell(Color foreground, Color background) : this(foreground, background, 0, Mirror.None) { }
        ...
        public Cell(Color foreground, Color background, int glyph) : this(foreground, background, glyph, Mirror.None) { }
        ...
        public Cell(Color foreground, Color background, int glyph, Mirror mirror)
        {
        ...
        */
        ...
        public bool Equals(Cell other)
        {
            return other != null &&
                   ...
                   EqualityComparer<CellState?>.Default.Equals(State, other.State);
        }

        public override int GetHashCode()
        {
            return HashCode.Combine(Decorators, Foreground, Background, Glyph, Mirror, IsVisible, State);
        }
