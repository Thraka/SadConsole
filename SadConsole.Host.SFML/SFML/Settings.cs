...
namespace SadConsole.Host
{
    public static class Settings
    {
        ...
        /// <summary>
        /// The target frames per second for the game window. Set before calling <see cref="SadConsole.Game.Create(int, int, string, RenderWindow)"/>.
        /// </summary>
        public static int FPS { get; set; } = 60;

        /// <summary>
        /// The game window title. Set before calling <see cref="SadConsole.Game.Create(int, int, string, RenderWindow)"/>.
        /// </summary>
