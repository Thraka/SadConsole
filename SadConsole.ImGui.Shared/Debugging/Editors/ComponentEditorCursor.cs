    ...
    public void BuildUI(ImGuiRenderer renderer, ScreenObjectState state, IComponent component)
    {
        ...
        ImGui.BeginGroup();
        {
            ...
            if (ImGui.CollapsingHeader("Render Appearance"u8))
            {
                ...
                {
                    SadConsole.ImGuiSystem.Types.ColoredGlyphReference glyphRef = _cursorAppearance;
                    SettingsTable.DrawCommonSettings(true, true, true, true, true, ref glyphRef,
                        ...
                        ((IScreenSurface)_screenObject).Font, renderer);
                    ...
                    if (glyphRef != _cursorAppearance)
                    {
                        ...
                        _cursorAppearance.Mirror = SadConsole.ImGuiSystem.Types.MirrorConverter.ToSadConsoleMirror(glyphRef.Mirror);
            ...
            if (ImGui.CollapsingHeader("Printing Behavior"u8))
            {
                ...
                {
                    SadConsole.ImGuiSystem.Types.ColoredGlyphReference glyphRef = _stateComponent.PrintAppearance;
                    ...
                    if (glyphRef != _cursorAppearance)
                    {
                        ...
                        _stateComponent.PrintAppearance.Mirror = SadConsole.ImGuiSystem.Types.MirrorConverter.ToSadConsoleMirror(glyphRef.Mirror);
                    }
