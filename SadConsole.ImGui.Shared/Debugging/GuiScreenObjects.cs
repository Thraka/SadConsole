...
public class GuiScreenObjects : ImGuiObjectBase
{
    ...
    public override void BuildUI(ImGuiRenderer renderer)
    {
        ...
        {
            // Screen objects list
            ImGuiSC.SeparatorText("Current Scene", ImGuiDebugger.Settings.Color_PanelHeader);
            ...
            if (ImGui.BeginListBox("##screen_objs_list", new Vector2(-1, 200)))
            {
                ...
                void ProcessItem(ScreenObjectState state)
                {
                    ...
                    if (state.Object.IsFocused) ImGui.PushStyleColor(ImGuiCol.Text, ImGuiDebugger.Settings.Color_FocusedObj);
