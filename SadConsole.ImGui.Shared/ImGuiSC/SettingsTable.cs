...
public static partial class SettingsTable
{
    ...
    public static void DrawCommonSettings(bool showForeground, bool showBackground, bool showMirror, bool showGlyph, bool enableSwapForeBackRightClick,
                                          ref ColoredGlyphReference glyphRef, Vector4? foregroundResetColor, Vector4? backgroundResetColor,
    ...
    public static void DrawCommonSettings(bool showForeground, bool showBackground, bool showMirror, bool showGlyph, bool enableSwapForeBackRightClick,
                                          ...
                                          ref SadConsole.ImGuiSystem.Types.Mirror mirror,
    ...
    public static bool DrawString(string label, ref string text, nuint maxLength)
    {
        ImGui.TableNextRow();
        ImGui.TableSetColumnIndex(0);
        ImGui.AlignTextToFramePadding();
        ...
        ImGui.SetNextItemWidth(-1);
        ImGui.PushID(label);
        bool edited = ImGui.InputText("##drawstring"u8, ref text, maxLength);
        ImGui.PopID();
        return edited;
    }
                                 ...
                                 ImGuiColorEditFlags flags = ImGuiColorEditFlags.AlphaPreviewHalf | ImGuiColorEditFlags.NoInputs)
    {
        ...
        if (showPalette)
        {
            ...
            if (ImGuiSC.PalettePopup.Show($"palettepopup_{id}", ref palColor))
    ...
    public static bool DrawMirror(string label, string id, ref SadConsole.ImGuiSystem.Types.Mirror mirror, int width = -1)
    {
        bool returnValue = false;
        ImGui.TableNextRow();
        ImGui.TableSetColumnIndex(0);
        ...
        int itemIndex = ImGuiListEnum<SadConsole.ImGuiSystem.Types.Mirror>.GetIndexFromValue(mirror);

        ImGui.SetNextItemWidth(width);
        if (ImGui.Combo(id, ref itemIndex, ImGuiListEnum<SadConsole.ImGuiSystem.Types.Mirror>.Names, ImGuiListEnum<SadConsole.ImGuiSystem.Types.Mirror>.Count))
        {
            mirror = ImGuiListEnum<SadConsole.ImGuiSystem.Types.Mirror>.GetValueFromIndex(itemIndex);
            returnValue = true;
        }
