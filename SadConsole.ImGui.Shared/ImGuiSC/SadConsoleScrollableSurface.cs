...
{
    public static bool ScrollableSurface(string id, IScreenSurface Surface, ImTextureRef texture, out SadRogue.Primitives.Point hoveredCellPosition, ImGuiRenderer renderer)
    {
        ...
        if (ImGui.BeginChild(id))
        {
            ...
            DrawTexture("output_preview_surface1", true, ImGuiSC.ZoomNormal, texture, imageSize, out var isActive, out var isHovered);
