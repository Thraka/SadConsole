namespace SadConsole.Consoles
{
    ...
    public partial class CustomConsole : IConsole
    {
        #region Events
        /// <summary>
        ...
        /// </summary>
        /// <remarks>If the <see cref="Engine.ActiveConsole"/> has the <see cref="CustomConsole.ExclusiveFocus"/> property set to true, you cannot use this property to set this console to focused.</remarks>
        ...
        public CustomConsole(int width, int height): this(width, height, Engine.DefaultFont) { }

        public CustomConsole(int width, int height, Font font) : this(new TextSurface(width, height, font)) { }

        public CustomConsole(TextSurface textData)
        {
