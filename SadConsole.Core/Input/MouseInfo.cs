...
namespace SadConsole.Input
{
    ...
    public class MouseInfo
    {
        ...
        public void Fill(IConsole data)
        {
            ...
            if (ConsoleLocation.X >= 0 && ConsoleLocation.X <= data.Data.RenderArea.Width - 1 &&
                ConsoleLocation.Y >= 0 && ConsoleLocation.Y <= data.Data.RenderArea.Height - 1)
            {
                ConsoleLocation = new Point(ConsoleLocation.X + data.Data.RenderArea.Location.X, ConsoleLocation.Y + data.Data.RenderArea.Location.Y);
                Cell = data.Data.Cells[ConsoleLocation.Y * data.Data.RenderArea.Width + ConsoleLocation.X];
                Console = data;
