...
public class Border: ScreenSurface
{
    ...
    public struct BorderParameters
    {
        ...
        /// <returns>The modified instance of <see cref="BorderParameters"/>.</returns>
        [MemberNotNull(nameof(BorderBox))]
        ...
        {
            if (BorderBox == null) throw new Exception($"Border is null, either pass one on the constructor or first call {nameof(ChangeBorderStyle)}");
        ...
        {
            if (BorderBox == null) throw new Exception($"Border is null, either pass one on the constructor or first call {nameof(ChangeBorderStyle)}");
            if (BorderBox.BorderGlyph == null) throw new Exception($"Border glyph is null, either pass one on the constructor or first call {nameof(ChangeBorderGlyph)}");
                                                                                                    ...
                                                                                                    font ?? contents.Font, contents.FontSize)
    {
        if (parameters.DrawBorder)
        {
            ...
            ColoredGlyphBase colorGlyph = parameters.BorderBox.BorderGlyph ?? parameters.BorderBox.BoxBorderStyleGlyphs[0];
                                                                                   ...
                                                                                   Color? borderBrightColor = null, Color? borderDarkColor = null, Color? borderBetweenColor = null)
    {
        ...
        BorderParameters borderParams = BorderParameters.GetDefault()
        ...
        Border border = new(contents, borderParams);
