...
public class TintSurfaceRenderStep : IRenderStep
{
    ...
    public void Render(IRenderer renderer, IScreenSurface screenObject)
    {
        if (screenObject.Tint.A != 0)
            GameHost.Instance.DrawCalls.Enqueue(new DrawCalls.DrawCallColor(screenObject.Tint.ToHostColor(), ((SadConsole.Host.GameTexture)screenObject.Font.Image).Texture, screenObject.AbsoluteArea.ToHostRectangle(), screenObject.Font.SolidGlyphRectangle.ToHostRectangle()));
    }
